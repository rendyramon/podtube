...
import br.com.harbsti.podtube.data.repository.DownloadRepository;
import br.com.harbsti.podtube.data.repository.Mp3Repository;
...
public class DownloadVideoUseCaseImpl implements DownloadVideoUseCase {
    ...
    public Observable<Download> downloadMp3(final Download download, final String dirToSave) {
        return  mp3Repository.getMp3(download.id())
                .flatMap(new Func1<byte[], Observable<br.com.harbsti.podtube.data.model.Download>>() {
                    @Override
                    public Observable<br.com.harbsti.podtube.data.model.Download> call(byte[] bytes) {
                        try {
                            ...
                            return Observable.just(br.com.harbsti.podtube.data.model.Download.builder()
                                    .id(download.id())
                ...
                }).flatMap(new Func1<br.com.harbsti.podtube.data.model.Download, Observable<br.com.harbsti.podtube.data.model.Download>>() {
                    @Override
                    public Observable<br.com.harbsti.podtube.data.model.Download> call(br.com.harbsti.podtube.data.model.Download download) {
