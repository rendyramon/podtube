...
public class DownloadDomainMapper extends Mapper<br.com.harbsti.podtube.data.model.Download, Download> {

    @Override
    public Download transform(br.com.harbsti.podtube.data.model.Download download) {
