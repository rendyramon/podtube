package br.com.harbsti.podtube.data.repository.impl.youtubedataapi;
...
import br.com.harbsti.podtube.data.model.Video;
...
public class ChannelYoutubeDataApiRepository implements ChannelRepository {
    ...
    @Override
    public Observable<Channel> getChannelDetail(final Channel channel) {
        return Observable.fromCallable(new Callable<Channel>() {
            @Override
            public Channel call() throws Exception {
                YouTube.Channels.List channelRequest = youTube.channels()
                        .list("brandingSettings,statistics,contentDetails")
                        .setId(channel.id());
